        ...
        <div className="bg-white py-8">
          <div className="container mx-auto px-4">
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button 
                onClick={() => scrollToSection('quote')}
                className="bg-yellow-500 hover:bg-yellow-600 text-black px-8 py-4 rounded-lg font-semibold text-lg transition-all hover:scale-105 flex items-center justify-center"
              >
                Solicitar Orçamento Gratuito
              ...
              <button 
                ...
                className="border-2 border-gray-900 text-gray-900 hover:bg-gray-900 hover:text-white px-8 py-4 rounded-lg font-semibold text-lg transition-all"
              >
                Nossos Serviços
              </button>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all hover:scale-105">
              <div className="bg-gray-100 w-16 h-16 rounded-full flex items-center justify-center mb-6">
                <Home className="text-gray-900" size={32} />
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Mudanças Residenciais</h3>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all hover:scale-105">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Mudanças Comerciais</h3>
              <p className="text-gray-600 mb-6">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all hover:scale-105">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Self Storage</h3>
              <p className="text-gray-600 mb-6">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all hover:scale-105">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Embalagem e Desembalagem</h3>
              <p className="text-gray-600 mb-6">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all hover:scale-105">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Elevador Exterior</h3>
              <p className="text-gray-600 mb-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-6">
                ...
                <div className="text-center">
                  ...
                  <div className="text-gray-600">Seguro Garantido</div>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Profissionais treinados e experientes</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <CheckCircle className="text-green-500 mr-3 mt-1 flex-shrink-0" size={20} />
                  <div>
                    ...
                    <p className="text-gray-600">Frota própria e equipamentos de última geração</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <CheckCircle className="text-green-500 mr-3 mt-1 flex-shrink-0" size={20} />
                ...
                <div className="flex items-start">
                  <CheckCircle className="text-green-500 mr-3 mt-1 flex-shrink-0" size={20} />
                  <div>
                    <h4 className="font-semibold text-gray-900">Preços Competitivos</h4>
                    <p className="text-gray-600">Melhor custo-benefício do mercado</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              ...
              <div className="flex items-center">
                <div className="w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center mr-4">
                  <span className="text-gray-900 font-semibold">MR</span>
                </div>
                <div>
                  <h4 className="font-semibold text-gray-900">Maria Rosa</h4>
                  <p className="text-gray-500">Cliente Residencial</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-500">Empresário</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-500">Cliente Self Storage</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold mb-4">Solicite Seu Orçamento Gratuito</h2>
            ...
            <div className="bg-white rounded-2xl p-8 text-gray-900">
              <form onSubmit={handleSubmit} className="grid md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2">
                  <button
                    type="submit"
                    className="w-full bg-yellow-500 hover:bg-yellow-600 text-black py-4 rounded-lg font-semibold text-lg transition-colors"
                  >
                    Solicitar Orçamento Gratuito
                  </button>
                </div>
          ...
          <div className="flex justify-center">
            <div className="grid md:grid-cols-2 gap-12 max-w-2xl">
              <div className="text-center">
                ...
                <p className="text-gray-600">+351 935 456 886</p>
                <p className="text-gray-600">212 131 169</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">Setúbal Quinta do Anjo</p>
              </div>
            </div>
          </div>
        </div>
